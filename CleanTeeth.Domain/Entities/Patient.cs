...
public class Patient : AuditableEntity, ISoftDeletable
{
    ...
    public Patient(string name, string patientnumber, DateTime dateofbirth, Gender gender, PhoneNumber phone, Email email, string address)
    {
        EnforceBusinessRules(name, patientnumber, dateofbirth, phone, email, address);
        Name = name;
    ...
    public void Update(string name, string patientnumber, DateTime dateofbirth, Gender gender, PhoneNumber phone, Email email, string address)
    {
        EnforceBusinessRules(name, patientnumber, dateofbirth, phone, email, address);
        Name = name;
        PatientNumber = patientnumber;
    ...
    private static void EnforceBusinessRules(string name, string patientnumber, DateTime dateofbirth, PhoneNumber phone, Email email, string address)
    {
